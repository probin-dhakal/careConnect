        ...
        <form onSubmit={onSubmitHandler} className='m-5 w-full'>
            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                ...
                <button
                    type='submit'
                    disabled={isLoading}
                    className={`inline-flex items-center gap-2 bg-primary px-10 py-3 mt-4 text-white rounded-full transition ${isLoading ? 'cursor-not-allowed opacity-80' : 'hover:opacity-90'}`}
                >
                    {isLoading && (
